...
export const SEGMENTS: Record<string, Segment> = {
  ...
  patients: {
    ...
    questions: [
      ...
      { id: 'what_now',
        text: 'If you found a sore or a cut on your foot tomorrow, what would you actually do?',
        type: 'single',
        options: ['Go to the clinic straight away', 'Wait a few days and see if it heals',
                  'Treat it myself at home', 'Ask a family member or neighbour what to do',
                  'Go to a pharmacy', 'I am not sure'] },
      { id: 'past_cost',
        text: 'Has a foot problem ever cost you money or time? Choose all that apply.',
        type: 'multi',
        options: ['No, never', 'Transport to the clinic', 'Treatment or medication',
                  'Days off work or trading', 'Someone had to care for me',
                  'A hospital stay'] },
      { id: 'meds_missed',
      ...
      { id: 'would_work', afterPitch: true,
        text: 'Would a solution like this work for you?',
        type: 'single',
        options: ['Yes, it would work for me', 'It might work, I am not sure',
                  'No, it would not work for me'],
        followUp: 'What makes you say that?' },
      { id: 'would_help_cost', afterPitch: true,
        text: 'Would catching a foot problem early save you money or trouble?',
        type: 'single',
        options: ['Yes, a great deal', 'Yes, a little', 'It would make no difference',
                  'I am not sure'] },
      ...
      { id: 'who_pays', afterPitch: true,
        text: 'Who do you think should pay for a service like this?',
        type: 'multi',
        options: ['My medical aid', 'The government or clinic', 'The patient themselves',
                  'A donor or charity', 'I am not sure'] },
  ...
  caregivers: {
    ...
    questions: [
      ...
      { id: 'what_now',
        text: 'If you noticed a sore on their foot tomorrow, what would happen next?',
        type: 'single',
        options: ['We would go to the clinic straight away', 'We would watch it for a few days',
                  'We would treat it at home', 'We would go to a pharmacy',
      ...
      { id: 'would_encourage', afterPitch: true,
        ...
        type: 'scale', scaleLow: 'Very unlikely', scaleHigh: 'Very likely' },
      { id: 'would_work', afterPitch: true,
        text: 'Would a solution like this help you support them?',
        type: 'single',
        options: ['Yes, it would help', 'It might help, I am not sure',
  ...
  nurses: {
    ...
    questions: [
      ...
      { id: 'equipment_access',
        text: 'Does this facility have the equipment it needs for proper foot examination?',
        type: 'single',
        options: ['Yes, we have what we need', 'We have some of it',
                  'No, we rely on visual inspection only',
                  'We have it but it is broken or shared']},
      { id: 'equipment_approval',
        text: 'If you requested new equipment, how likely is it to be approved and arrive?',
        type: 'scale', scaleLow: 'Very unlikely', scaleHigh: 'Very likely' },
      ...
      { id: 'would_work', afterPitch: true,
        text: 'Would a solution like this work in your clinic?',
        type: 'single',
        options: ['Yes, it would work here', 'It might work, with changes',
                  'No, it would not work here'],
        followUp: 'What makes you say that?' },
      { id: 'would_reduce_cost', afterPitch: true,
        text: 'Would earlier screening reduce the cost of treating diabetic foot problems here?',
        type: 'single',
        options: ['Yes, significantly', 'Yes, a little', 'It would make no difference',
                  'I am not sure'] },
      { id: 'screen_volume', afterPitch: true,
        text: 'If this facility had one screening mat, how many patients could you realistically screen in a week?',
        type: 'single',
        options: ['Fewer than 10', '10 to 25', '26 to 50', 'More than 50',
                  'We would not have time for it'] },
      ...
      { id: 'reduce_admissions', afterPitch: true,
        text: 'In your view, would earlier foot screening reduce hospital admissions for diabetic patients?',
        type: 'scale', scaleLow: 'No difference', scaleHigh: 'Large reduction' },
  ...
  doctors: {
    ...
    questions: [
      ...
      { id: 'reduce_admissions',
        text: 'Would earlier detection meaningfully reduce amputations and admissions in your setting?',
        type: 'scale', scaleLow: 'No difference', scaleHigh: 'Large reduction' },
      { id: 'would_work',
        text: 'Would a solution like this be useful in your setting?',
        type: 'single',
        options: ['Yes, it would be useful', 'It might be, with conditions',
  ...
  atrisk: {
    key: 'atrisk',
    title: 'People who think they may have diabetes',
    audience: 'For anyone not diagnosed, but who wonders whether they might have diabetes.',
    intro: CONSENT + ' This questionnaire cannot tell you whether you have diabetes. ' +
      'If you are concerned, please visit a clinic for a blood sugar test, it is quick ' +
    ...
    questions: [
      ...
      { id: 'gender', text: 'Are you male or female?', type: 'single',
        options: ['Male', 'Female', 'Prefer not to say'] },
      { id: 'family', text: 'Does anyone in your close family have diabetes?', type: 'single',
        options: ['Yes', 'No', 'I do not know'] },
      { id: 'tested', text: 'Have you ever been tested for diabetes?', type: 'single',
        options: ['Yes, within the last year', 'Yes, more than a year ago',
                  'No, never', 'I am not sure'] },
      { id: 'why_wonder',
        text: 'What makes you wonder whether you might have diabetes? Choose all that apply.',
        type: 'multi',
        options: ['Family history', 'Something I noticed about my health',
                  'Someone suggested I get tested', 'My weight or lifestyle',
                  'General concern, no particular reason'] },
      { id: 'barriers',
        text: 'What has stopped you getting tested? Choose all that apply.',
        type: 'multi',
        options: ['Nothing, I have been tested', 'The cost', 'Distance to a clinic',
                  'No time', 'I would rather not know', 'I did not know where to go',
                  'I did not think it was serious'] },
      { id: 'foot_aware',
        text: 'Did you know that diabetes can cause serious foot problems, including amputation?',
        type: 'single', options: ['Yes, I knew this well', 'I had heard something about it',
                                  'No, this is new to me'] },
      { id: 'what_now',
        text: 'If you decided to get checked tomorrow, where would you go?',
        type: 'single',
        options: ['A government clinic', 'A private doctor', 'A pharmacy',
                  'A hospital', 'I would not know where to go'] },
      { id: 'worry', text: 'How worried are you about your own health?',
        type: 'scale', scaleLow: 'Not worried at all', scaleHigh: 'Very worried' },

      { id: 'would_screen', afterPitch: true,
        text: 'If free testing and a foot scan were offered at a clinic near you, how likely would you be to go?',
        type: 'scale', scaleLow: 'Very unlikely', scaleHigh: 'Very likely' },
      { id: 'would_work', afterPitch: true,
        text: 'Would a solution like this work for you?',
        type: 'single',
        ...
        followUp: 'What makes you say that?' },
      { id: 'features', afterPitch: true,
        text: 'Which of these would be useful to you? Choose all that apply.',
        type: 'multi',
        options: ['A reminder to get tested', 'Seeing my own results on my phone',
                  'Logging my weight and blood sugar', 'Foot care and prevention tips',
                  'Being able to message a nurse'] },
      { id: 'other', afterPitch: true,
        text: 'Anything else you want to tell us?', type: 'text', optional: true },
    ],
  },
}
